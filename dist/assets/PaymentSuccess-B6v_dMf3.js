import{j as e}from"./index-CfhsyVHk.js";function l(){const a=`TXN${Math.random().toString(36).substr(2,9).toUpperCase()}`,s=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}),n=()=>{const t=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="UTF-8">
